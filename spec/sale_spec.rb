...
describe BraspagRest::Sale do
  ...
  context 'Billet' do
    let(:braspag_response) {
      {
        ...
        'Payment' => {
          ...
          'ReasonCode' => 0,
          'Country' => 'BRA',
          'ReceivedDate': '2016-10-08 17:26:24',
          ...
          'Links' => [
            {
              'Href' => 'https://apiqueryhomolog.braspag.com.br/v2/sales/a5f3181d-c2e2-4df9-a5b4-d8f6edf6bd51',
              'Method' => 'GET',
              'Rel' => 'self'
            }
          ]
    ...
    describe '.new' do
      ...
      it 'initializes a sale using braspag response format' do
        expect(sale.order_id).to eq('2014111706')
        expect(sale.payment).to be_an_instance_of(BraspagRest::Payment)
        expect(sale.customer).to be_an_instance_of(BraspagRest::Customer)
      end
    end
